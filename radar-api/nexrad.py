...
from _tools import Array, BitField, Bits, DictStruct, Enum, IOBuffer, NamedStruct, open_as_needed, zlib_decompress_all_frames
...
class Level2File:
    ...
    def _decode_msg3(self, msg_hdr):
        try:
            ...
            # Metadata tables not bundled; msg 3 (maintenance data) is not
            # needed for moment extraction, skip it.
            self._buffer_segment(msg_hdr)
            return
    ...
    def _decode_msg18(self, msg_hdr):
        ...
        if data and self.vol_hdr.version[:8] not in (b'ARCHIVE2', b'AR2V0001'):
            try:
                ...
                # Metadata tables not bundled; msg 18 (RDA adaptation data) is
                # not needed for moment extraction, skip it.
                return
